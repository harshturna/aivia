  ...
  return (
    <section className="bg-slate-50 dark:bg-slate-900">
      <div className="container space-y-8 py-12 text-center lg:py-20">
        ...
        <div className="flex gap-2 flex-col md:flex-row items-center gap-5">
          {featureCards.content.map((cards: any) => {
            ...
            return (
              <Card
                key={cards.text}
                className={cn(
                  "flex flex-grow w-[280px] h-[280px] md:w-[30px] md:h-[280px] flex-col items-center justify-center gap-2 dark:bg-secondary",
                  cards.color,
                  cards.bgColor
                )}
              >
